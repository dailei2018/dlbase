 ...
 * have side effects. */
#define ROUND_256(a,b,c,d,e,f,g,h,k,data) do {		\
...
sha256_transform(uint32_t *state, uint32_t *data)
{
  ...
  for (i = 0, k = K, d = data; i<16; i+=8, k += 8, d+= 8)
    {
      ROUND_256(A, B, C, D, E, F, G, H, k[0], d[0]);
      ROUND_256(H, A, B, C, D, E, F, G, k[1], d[1]);
      ROUND_256(G, H, A, B, C, D, E, F, k[2], d[2]);
      ROUND_256(F, G, H, A, B, C, D, E, k[3], d[3]);
      ROUND_256(E, F, G, H, A, B, C, D, k[4], d[4]);
      ROUND_256(D, E, F, G, H, A, B, C, k[5], d[5]);
      ROUND_256(C, D, E, F, G, H, A, B, k[6], d[6]);
      ROUND_256(B, C, D, E, F, G, H, A, k[7], d[7]);
    }
  
  for (; i<64; i += 16, k+= 16)
    {
      ROUND_256(A, B, C, D, E, F, G, H, k[ 0], EXPAND(data,  0));
      ROUND_256(H, A, B, C, D, E, F, G, k[ 1], EXPAND(data,  1));
      ROUND_256(G, H, A, B, C, D, E, F, k[ 2], EXPAND(data,  2));
      ROUND_256(F, G, H, A, B, C, D, E, k[ 3], EXPAND(data,  3));
      ROUND_256(E, F, G, H, A, B, C, D, k[ 4], EXPAND(data,  4));
      ROUND_256(D, E, F, G, H, A, B, C, k[ 5], EXPAND(data,  5));
      ROUND_256(C, D, E, F, G, H, A, B, k[ 6], EXPAND(data,  6));
      ROUND_256(B, C, D, E, F, G, H, A, k[ 7], EXPAND(data,  7));
      ROUND_256(A, B, C, D, E, F, G, H, k[ 8], EXPAND(data,  8));
      ROUND_256(H, A, B, C, D, E, F, G, k[ 9], EXPAND(data,  9));
      ROUND_256(G, H, A, B, C, D, E, F, k[10], EXPAND(data, 10));
      ROUND_256(F, G, H, A, B, C, D, E, k[11], EXPAND(data, 11));
      ROUND_256(E, F, G, H, A, B, C, D, k[12], EXPAND(data, 12));
      ROUND_256(D, E, F, G, H, A, B, C, k[13], EXPAND(data, 13));
      ROUND_256(C, D, E, F, G, H, A, B, k[14], EXPAND(data, 14));
      ROUND_256(B, C, D, E, F, G, H, A, k[15], EXPAND(data, 15));
    }
