...
static dl_table *dl_table_init(dl_table *t, int narray, int nhash, dl_t_void_del_pt h);
...
dl_table *dl_table_new(dl_log *log, int narray, int nhash, dl_t_void_del_pt h)
{
